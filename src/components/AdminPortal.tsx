            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full mt-2 bg-transparent border-b border-border px-0 py-3 pr-10 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-foreground transition-colors"
